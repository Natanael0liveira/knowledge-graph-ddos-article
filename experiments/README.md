...
| Sprint | Status |
|---|---|
| **1** — Pipeline de extração | 🛠️ Infraestrutura pronta, aguardando execução |
| 2 — Gerador sintético | ⏳ Será montado após validação do Sprint 1 |
| 3 — Baselines + ablação | ⏳ |
| 4 — Execução completa + calibração | ⏳ |
| 5 — Comparação com KLAGE | ⏳ |
