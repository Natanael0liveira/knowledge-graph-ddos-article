...
A Fig.~\ref{fig:rules} mostra uma regra de cada tipo.
...
todas produzem um filtro diretamente aplicável (Fig.~\ref{fig:chain}). Um estudo
...
Apêndice~\ref{app:cost}). O que a abordagem em nível de sessão acrescenta
