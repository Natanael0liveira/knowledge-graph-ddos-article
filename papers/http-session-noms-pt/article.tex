...
$14$--$20$~ns por par candidato, sustentando cerca de $84\,000$ admissões de sessão
...
está ali para elevar a AUC: ele compra um vocabulário tipado e inspecionável em
que veredicto, evidência e escopo de mitigação são uma só derivação, exportável
para STIX sem etapa de tradução. A camada simbólica
