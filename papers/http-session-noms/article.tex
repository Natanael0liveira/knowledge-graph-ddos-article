...
already reaches $\mathrm{AUC} \geq 0.98$, leaving cross-session reasoning only a
marginal gain. The advantage is decisive only when the campaign is distributed
