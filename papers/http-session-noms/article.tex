...
laboratory datasets --- a few dozen distinct JA4 fingerprints --- optimization
...
symbolic materialization and the $\Omega$ aggregation per window --- so we time
...
permissive license, organized by experimental stage: the extraction pipeline
