...
$K$ of the campaign, so the evaluation is parameterized by $K$ rather than by
...
occupancy. Two results carry: admission costs a constant $14$--$20$~ns per
...
not to expressing it in OWL. The formalism is not there to raise AUC: it buys a
typed, inspectable vocabulary in which verdict, evidence and mitigation scope are
one derivation, exportable to STIX without a translation step. The symbolic layer
