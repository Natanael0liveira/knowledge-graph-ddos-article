...
directions track the limitations: a captured stealthy distributed campaign, which
no benchmark yet provides and which bounds external validity more than anything
else; a multi-origin testbed and the two-tier sharding of
Section~\ref{sec:discussion} to validate cost at CDN scale; HTTP/2 attacks and
the three sub-relations the available traffic does not expose; and a
human-analyst study of the evidence chains.
