...
\begin{tabular}{@{}lllll@{}}
\toprule
Work & Reasoning unit & Cross-session relation & Verdict explanation & Mitigation scope \\
\midrule
Fernandes et al.~\cite{fernandes2015autonomous}      & flow statistics     & ---                          & ---                 & --- \\
Bharathi and Sukanesh~\cite{bharathi2012pca}         & session as vector   & ---                          & ---                 & --- \\
Kemp et al.~\cite{kemp2023approach}                  & session as vector   & ---                          & ---                 & --- \\
Sadlek et al.~\cite{sadlek2024device}                & network device      & learned (link prediction)    & ---                 & --- \\
Wang and Stadler~\cite{wang2024intrusion}            & network node        & learned (action sequences)   & ---                 & --- \\
KLAGE~\cite{belcastro2025klage}                      & network node        & learned embeddings           & LLM report          & --- \\
Bot management, industrial~\cite{althouse2023ja4}    & session             & proprietary, TLS similarity  & ---                 & undisclosed \\
\midrule
\textbf{This work} & application session & \textbf{explicit, typed, weighted} & symbolic derivation & \textbf{derived from the same graph} \\
\bottomrule
\end{tabular}
\end{table*}
...
and whether a mitigation scope follows from the same representation.
