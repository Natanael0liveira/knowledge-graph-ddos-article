...
while RDF materialization and the $\Omega$ aggregation run once per window, three
...
Fig.~\ref{fig:ontology} is a hand-drawn schematic, and its editable source ships
with the artifact. The OWL
